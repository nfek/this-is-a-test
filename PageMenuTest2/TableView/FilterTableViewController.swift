...
class FilterTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, MovieTableViewDelegate{
...
//import UIKit
//
//class FilterTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, FilterTableViewDelegate {
...
//
//    var sections = [
//        FilterSection(genre: "🦁 Animation",
//                movies: ["The Lion King", "The Incredibles"],
//                expanded: false,
//                subtitle: "Please select a movie"),
//        FilterSection(genre: "💥 Superhero",
//                movies: ["Guardians of the Galaxy", "The Flash", "The Avengers", "The Dark Knight"],
//                expanded: false,
//                subtitle: "Please select a movie"),
//        FilterSection(genre: "👻 Horror",
//                movies: ["The Walking Dead", "Insidious", "Conjuring"],
//                expanded: false,
//                subtitle: "Please select a movie")
//    ]
...
//
//    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
//        let header = FilterTableViewDelegate()
...
//    }
//
//    func toggleSection(header: FilterTableViewDelegate, section: Int) {
//        sections[section].expanded = !sections[section].expanded
//
//
//        tableView.beginUpdates()
